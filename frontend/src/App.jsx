    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-1.5 sm:gap-2 md:gap-4 mb-3 sm:mb-4 md:mb-6">
        ...
        <MetricCard
          ...
          value={
            getOverallStatus().charAt(0).toUpperCase() +
            getOverallStatus().slice(1)
          }
          icon={Droplets}
...
function Settings({
  ...
  const { units, setUnits, timeFormat, setTimeFormat, timezone, setTimezone } =
      ...
      {activeTab === "appearance" && (
        <div className="space-y-5">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-5 transition-colors duration-300">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              This color will be used for various interface elements like
              buttons, links and charts.
            </p>
          </div>
        </div>
      )}
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    This is how dates and times will appear in charts, logs, and
                    alerts.
                  </div>
                </div>
              </div>
              ...
              <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="relative inline-block w-16 h-8">
                    ...
                    />
                    <div className="absolute inset-0 rounded-full overflow-hidden flex border border-gray-200 dark:border-gray-600">
                      <div
                        className={`w-1/2 h-full flex items-center justify-center text-xs ${
                          units.temperature === "C"
              ...
              <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleUnitChange("turbidity", e.target.value)
                    }
              ...
              <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleUnitChange("waterLevel", e.target.value)
                    }
                    className="text-sm p-1 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700"
                  >
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  Example:{" "}
                  {units.waterLevel === "cm" || units.waterLevel === "m"
                    ? "35 "
                    : "13.8 "}
                  {units.waterLevel}
                </div>
        ...
        <div className="space-y-5">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-5 transition-colors duration-300">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-5">
              Adjust warning and critical thresholds for water quality
              parameters. These thresholds determine when alerts are triggered.
            </p>
      ...
      {activeTab === "notifications" && (
        <div className="space-y-5">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-5 transition-colors duration-300">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-5">
              Configure how and when you want to be notified about water quality
              alerts.
            </p>
                  ...
                  <div className="space-y-3 mt-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleRecipientsChange("email", e.target.value)
                        }
                      ...
                      <div className="flex space-x-4">
                        <label className="flex items-center text-sm dark:text-gray-300">
                          <input
                            type="checkbox"
                            className="mr-2 h-4 w-4 text-blue-500"
                            checked={notifications.email.levels.includes(
                              "critical"
                            )}
                            onChange={() =>
                              handleLevelToggle("email", "critical")
                            }
                          />
                          Critical
                        </label>
                        <label className="flex items-center text-sm dark:text-gray-300">
                          <input
                            ...
                            onChange={() =>
                              handleLevelToggle("email", "warning")
                            }
                          />
                          Warning
                        </label>
                  ...
                  <div className="space-y-3 mt-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleRecipientsChange("sms", e.target.value)
                        }
                      ...
                      <div className="flex space-x-4">
                        <label className="flex items-center text-sm dark:text-gray-300">
                          <input
                            type="checkbox"
                            className="mr-2 h-4 w-4 text-blue-500"
                            checked={notifications.sms.levels.includes(
                              "critical"
                            )}
                            onChange={() =>
                              handleLevelToggle("sms", "critical")
                            }
                          />
                          Critical
                        </label>
                      ...
                      <div className="flex space-x-4">
                        <label className="flex items-center text-sm dark:text-gray-300">
                          <input
                            type="checkbox"
                            className="mr-2 h-4 w-4 text-blue-500"
                            checked={notifications.push.levels.includes(
                              "critical"
                            )}
                            onChange={() =>
                              handleLevelToggle("push", "critical")
                            }
                          />
                          Critical
                        </label>
                        <label className="flex items-center text-sm dark:text-gray-300">
                          <input
                            ...
                            onChange={() =>
                              handleLevelToggle("push", "warning")
                            }
                          />
                          Warning
                        </label>
...
function ThresholdSlider({
  ...
  const getStatus = () => {
    ...
    if (currentValue > moderateHigh || currentValue < moderateLow)
      return "moderate";
    return "good";
  };
      ...
      <div className="relative h-6 mb-3">
        ...
        <div className="absolute inset-0 rounded-full overflow-hidden">
          <div className="relative w-full h-full">
            ...
            {/* Warning zones */}
            <div
              className="absolute left-0 h-full bg-yellow-100 dark:bg-yellow-900"
              style={{ width: `${lowPosition}%` }}
            ></div>
            <div
              className="absolute right-0 h-full bg-yellow-100 dark:bg-yellow-900"
              style={{ width: `${100 - highPosition}%` }}
            ></div>
...
function App() {
  ...
  const getStatus = (value, type) => {
    ...
    switch (type) {
      case "temperature":
        ...
        return value > thresholds.temperature.high ||
          value < thresholds.temperature.low
          ? "poor"
          : value > thresholds.temperature.high - 2 ||
            value < thresholds.temperature.low + 2
          ? "moderate"
          : "good";
      case "turbidity":
        if (!thresholds.turbidity) return "good"; // Protect against undefined thresholds
        return value > thresholds.turbidity.high
          ? "poor"
          : value > thresholds.turbidity.high * 0.75
          ? "moderate"
          : "good";
      case "pH":
        if (!thresholds.pH) return "good"; // Protect against undefined thresholds
        return value > thresholds.pH.high || value < thresholds.pH.low
          ? "poor"
          : value > thresholds.pH.high - 0.5 || value < thresholds.pH.low + 0.5
          ? "moderate"
          : "good";
      default:
        return "good";
  ...
  const getOverallStatus = () => {
    ...
    if (tempStatus === "poor" || turbStatus === "poor" || phStatus === "poor")
      return "poor";
    if (
      tempStatus === "moderate" ||
      turbStatus === "moderate" ||
  ...
  return (
    <ThemeContext.Provider value={{ theme, setTheme }}>
      ...
      >
        <Router>
          <div
            className="min-h-screen w-full overflow-x-hidden flex flex-col relative transition-colors duration-300"
            style={{
              backgroundColor:
                theme.mode === "dark"
                  ? "rgb(17, 24, 39)"
                  : "rgb(248, 250, 252)",
              color: theme.mode === "dark" ? "white" : "rgb(17, 24, 39)",
            }}
          >
            <Sidebar />
                ...
                <div className="container mx-auto px-0 sm:px-2">
                  <Routes>
                    ...
                    <Route
                      path="/charts"
                      element={
                        <Charts dataHistory={dataHistory} units={units} />
                      }
                    />
                    <Route
                      path="/settings"
