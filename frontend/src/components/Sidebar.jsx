...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar wrapper - only render on mobile when menu clicked */}
      {(windowWidth >= 768 || mobileMenuOpen) && (
        <div
          className={`fixed h-full
          ${windowWidth < 768 ? "w-56" : "w-16 md:w-20"} translate-x-0
          bg-slate-800 dark:bg-gray-900 text-white flex flex-col items-center py-6 space-y-6 shadow-lg transition-all duration-300 z-20 md:z-10
        `}
        >
          <div
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`p-3 md:p-2.5 rounded-lg transition-colors duration-200 relative group flex items-center
                    ${
                      isActive
                ...
                >
                  ...
                  {/* show label next to icon on mobile when open */}
                  {windowWidth < 768 && mobileMenuOpen && (
